...
# Paths
parser.add_argument('--training-dataset', type=str, default='all', help='dataset to use for training')
...
if args.training_dataset == 'all':
    if args.training_image_path == '':
        args.training_image_path = 'datasets/all/'
    if args.training_tnf_csv == '' and args.geometric_model=='affine':
        args.training_tnf_csv = 'training_data/all-synth-aff'
